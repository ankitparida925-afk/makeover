          ...
          <div className="relative rounded-none bg-[#EEDAD1]/50 border border-white/60 p-8 lg:p-16 overflow-hidden text-center max-w-[1000px] mx-auto">
            <div className="relative z-10 max-w-2xl mx-auto space-y-6">
              ...
              <div className="flex flex-wrap justify-center gap-4 pt-4">
                ...
                <Link to="/services#our-offerings" className="border border-gold text-gold rounded-none px-10 py-4.5 text-xs font-bold tracking-widest uppercase hover:bg-gold hover:text-black transition-all duration-300 inline-block">
                  Explore Services
                </Link>
              </div>
            </div>
